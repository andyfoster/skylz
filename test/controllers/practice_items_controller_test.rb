...
class PracticeItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice_item" do
    assert_difference("PracticeItem.count") do
      post practice_items_url, params: { practice_item: { PracticeList_id: @practice_item.PracticeList_id, skill_id: @practice_item.skill_id } }
    end
  ...
  test "should update practice_item" do
    patch practice_item_url(@practice_item), params: { practice_item: { PracticeList_id: @practice_item.PracticeList_id, skill_id: @practice_item.skill_id } }
